...
-- Stop-loss efficiency tracking (Strategy Tracker): entry_price/stop_loss are the
-- planned levels; extreme_price is the worst price reached against the trade
-- (lowest price for longs, highest price for shorts).
ALTER TABLE public.strategy_setups
